...
def main(xmin: float, ymin: float, xmax: float, ymax: float,
    ...
    WMTS_URL_FINAL = urllib.parse.unquote(
        urllib.parse.urlencode(WMTS_URL_PARAMS))
...
if __name__ == "__main__":
    ...
    start = time.time()
    main(args.xmin, args.ymin, args.xmax, args.ymax,
         args.epsg, args.display, args.path, args.resolution)
    end = time.time()
    duration = end - start
    if args.time:
